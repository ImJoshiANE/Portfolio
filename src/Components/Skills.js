...
const Skills = () => {
  return (
    <>
      <h2 className=" w-full text-center mt-64 font-bold text-8xl md:text-6xl md:mt-32">Skills</h2>
      ...
      ">
        <motion.div
          className=" flex items-center justify-center rounded-full font-semibold bg-dark text-light p-8 shadow-dark cursor-pointer dark:bg-light dark:text-dark lg:p-6 md:p-4 xs:p-2 xs:text-xs"
          whileHover={{ scale: 1.05 }}
        >
          Web
        </motion.div>
